...
import { TicketSettingDetails } from '@/types/bluetick/db/tickets';
...
export const useFetchGuildTicketSetting = (botID: string, guildID: string) => {
  return useQuery<TicketSettingDetails, Error>(
    ['guildTicketSetting', botID, guildID],
    () => fetchGuildTicketSetting(botID, guildID),
    {
