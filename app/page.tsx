  ...
  return (
    ...
    >
      <div className="p-8 flex flex-col justify-center ml-0 sm:ml-auto mr-0 sm:mr-12 items-center sm:items-end h-full gap-4 max-w-[600px] ">
        <h1
          className={`text-5xl sm:text-6xl xl:text-7xl font-bold text-center sm:text-end text-yellow-500 backdrop-blur-sm rounded-lg p-2 ${rubikFont.className}`}
        >
          The Discord Bot that do everything automatically.
        </h1>
        <p
          className={`text-md text-gray-200 text-white text-center sm:text-end font-semibold text-wrap backdrop-blur-sm rounded-lg p-2 ${poppinsFont.className}`}
        >
